...
public class TrackObject: ScriptableObject
{
    ...
    protected virtual void Construct()
    {
        ...
        for (int i = 0; i < Length; i++)
        {
            ...
            // Save the scenery sprite so it can be restored if temporarily overwritten by a token/car
            line.originalSprite = line.sprite;
            line.originalSpriteX = line.spriteX;
            line.tokenIndex = -1;
            line.npcBlockedLane = -99;
